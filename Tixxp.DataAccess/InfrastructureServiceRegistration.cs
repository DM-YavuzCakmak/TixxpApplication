...
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.Campaign;
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.CampaignAction;
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.CampaignCondition;
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.CampaignConditionType;
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.Channel;
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.ChannelTranslation;
...
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.EventTranslation;
...
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.ProductSaleStatus;
using Tixxp.Infrastructure.DataAccess.Concrete.EntityFramework.ProductSaleStatusTranslation;
...
public static class InfrastructureServiceRegistration
{
    public static IServiceCollection AddInfrastructureServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<IProductSaleStatusRepository, ProductSaleStatusRepository>();
        services.AddScoped<IProductSaleStatusTranslationRepository, ProductSaleStatusTranslationRepository>();
        services.AddScoped<ICounterTranslationRepository, CounterTranslationRepository>();
        services.AddScoped<ICampaignConditionTypeRepository, CampaignConditionTypeRepository>();
        services.AddScoped<IChannelTranslationRepository, ChannelTranslationRepository>();
        services.AddScoped<ICampaignConditionRepository, CampaignConditionRepository>();
        services.AddScoped<ICampaignActionRepository, CampaignActionRepository>();
        ...
        services.AddScoped<IEventTranslationRepository, EventTranslationRepository>();
