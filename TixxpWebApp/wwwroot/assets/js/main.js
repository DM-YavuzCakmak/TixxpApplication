(function () {
  "use strict";
  if (localStorage.getItem("Adminordarktheme")) {
  ...
  function localStorageBackup() {
    ...
    if (localStorage.Adminordarktheme) {
      let html = document.querySelector("html");
      html.setAttribute("data-theme-mode", "dark");
    }
    if (localStorage.Adminorlayout) {
      let html = document.querySelector("html");
      let layoutValue = localStorage.getItem("Adminorlayout");
      html.setAttribute("data-nav-layout", "horizontal");
      setTimeout(() => {
        clearNavDropdown();
      }, 5000);
    ...
    if (localStorage.Adminorverticalstyles) {
      let html = document.querySelector("html");
      let verticalStyles = localStorage.getItem("Adminorverticalstyles");

      if (verticalStyles == "default") {
        html.setAttribute("data-vertical-style", "default");
        localStorage.removeItem("Adminornavstyles");
      }
        ...
        setTimeout(() => {
          ...
          menuSlideItem.forEach((e) => {
            ...
            e.addEventListener("mouseenter", () => {
              if (localStorage.Adminorverticalstyles == "doublemenu") {
    ...
    if (localStorage.Adminornavstyles) {
      let html = document.querySelector("html");
      let navStyles = localStorage.getItem("Adminornavstyles");
      if (navStyles == "menu-click") {
        html.setAttribute("data-nav-style", "menu-click");
        localStorage.removeItem("Adminorverticalstyles");
    ...
    if (localStorage.Adminorclassic) {
      let html = document.querySelector("html");
      html.setAttribute("data-page-style", "classic");
    }
    if (localStorage.Adminormodern) {
      let html = document.querySelector("html");
      html.setAttribute("data-page-style", "modern");
    }
    if (localStorage.Adminorboxed) {
      let html = document.querySelector("html");
      html.setAttribute("data-width", "boxed");
    }
    if (localStorage.Adminorheaderfixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "fixed");
    }
    if (localStorage.Adminorheaderscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-header-position", "scrollable");
    }
    if (localStorage.Adminormenufixed) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "fixed");
    }
    if (localStorage.Adminormenuscrollable) {
      let html = document.querySelector("html");
      html.setAttribute("data-menu-position", "scrollable");
    }
    if (localStorage.AdminorMenu) {
      let html = document.querySelector("html");
      let menuValue = localStorage.getItem("AdminorMenu");
      switch (menuValue) {
        case "light":
    ...
    if (localStorage.AdminorHeader) {
      let html = document.querySelector("html");
      let headerValue = localStorage.getItem("AdminorHeader");
      switch (headerValue) {
        case "light":
