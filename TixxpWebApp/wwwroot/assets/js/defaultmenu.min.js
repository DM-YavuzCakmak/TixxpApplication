...
const slideUp = (target, duration = DURATION) => {
...
const slideDown = (target, duration = DURATION) => {
  const { parentElement } = target;
...
const slideToggle = (target, duration = DURATION) => {
...
(() => {
  ...
  headerToggleBtn && headerToggleBtn.addEventListener('click', toggleSidemenu);
  ...
  if (
    !localStorage.getItem("Adminorlayout") &&
    !localStorage.getItem("Adminornavstyles") &&
    !localStorage.getItem("Adminorverticalstyles") &&
      ...
      switch (verticalStyle) {
        ...
        case "overlay":
          ...
          if (html.getAttribute('data-toggled') === 'icon-overlay-close') {
            ...
            if (window.innerWidth >= 992) {
              if (!localStorage.getItem("Adminorlayout")) {
