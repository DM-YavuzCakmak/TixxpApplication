...
function switcherClick() {
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("AdminorMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("AdminorMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("AdminorMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("AdminorHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-styles', 'gradient');
        localStorage.setItem("AdminorHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("AdminorHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Adminorfullwidth", true);
        localStorage.removeItem("Adminorboxed");
    });
    ...
    let boxedVar = boxedBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Adminorboxed", true);
        localStorage.removeItem("Adminorfullwidth");
        checkHoriMenu()
    });
    /* Boxed Layout End */
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("Adminorregular", true);
        localStorage.removeItem("Adminorclassic");
        localStorage.removeItem("Adminormodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("Adminorclassic", true);
        localStorage.removeItem("Adminorregular");
        localStorage.removeItem("Adminormodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("Adminormodern", true);
        localStorage.removeItem("Adminorregular");
        localStorage.removeItem("Adminorclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Adminorheaderfixed", true);
        localStorage.removeItem("Adminorheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("Adminorheaderscrollable", true);
        localStorage.removeItem("Adminorheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Adminormenufixed", true);
        localStorage.removeItem("Adminormenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("Adminormenuscrollable", true);
        localStorage.removeItem("Adminormenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("Adminorverticalstyles", 'closed');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("Adminorverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("Adminorverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("Adminorverticalstyles", 'overlay');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("Adminorverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("Adminornavstyles", 'menu-click');
        localStorage.removeItem("Adminorverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("Adminornavstyles", 'menu-hover');
        localStorage.removeItem("Adminorverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("Adminornavstyles", 'icon-click');
        localStorage.removeItem("Adminorverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("Adminornavstyles", 'icon-hover');
        localStorage.removeItem("Adminorverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("Adminorlayout");
        localStorage.setItem("Adminorverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("Adminorlayout", 'horizontal');
        localStorage.removeItem("Adminorverticalstyles");
...
function lightFn() {
    ...
    localStorage.removeItem("AdminorbgColor");
    localStorage.removeItem("Adminorheaderbg");
    localStorage.removeItem("Adminorbgwhite");
    localStorage.removeItem("Adminormenubg");
    localStorage.removeItem("Adminormenubg");
    checkOptions();
...
function horizontalClickFn() {
    ...
    if(!localStorage.AdminorMenu && !localStorage.bodylightRGB){
        html.setAttribute("data-menu-styles","light")
        document.querySelector('#switcher-menu-light').checked = true;
        checkOptions();
    }
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('AdminorHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('AdminorHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('AdminorHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('AdminorHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('AdminorHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('AdminorMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('AdminorMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('AdminorMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('AdminorMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('AdminorMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('Adminorboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('Adminorheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('Adminormenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('Adminorheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('Adminormenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('Adminorclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('Adminormodern')) {
...
function updateColors() {
    ...
    if (document.querySelector("#average-sales") !== null) {
        averagesales();
    }
    if (document.querySelector("#sales-statistics") !== null) {
        salesStatistics();
    }
